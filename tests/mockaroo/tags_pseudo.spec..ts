...
test('TAG02. Actualizar Tag. Crear Tag con datos básicos y actualizar', async ({ page, request }) => {
  await page.goto(GhostURL);
  await page.getByPlaceholder('jamie@example.com').click();
  await page.getByPlaceholder('jamie@example.com').fill(USERNAME);
  await page.getByPlaceholder('jamie@example.com').press('Tab');
...
test('TAG03. Eliminar Tag. Crear Tag con datos básicos y Eliminar Tag', async ({ page,request }) => {
  await page.goto(GhostURL);
  await page.getByPlaceholder('jamie@example.com').click();
  await page.getByPlaceholder('jamie@example.com').fill(USERNAME);
  await page.getByPlaceholder('jamie@example.com').press('Tab');
...
test('TAG04. Crear Tag con datos básicos excepto el campo name', async ({ page,request }) => {
  await page.goto(GhostURL);
  await page.getByPlaceholder('jamie@example.com').click();
  await page.getByPlaceholder('jamie@example.com').fill(USERNAME);
  await page.getByPlaceholder('jamie@example.com').press('Tab');
...
test('TAG05. Crear Tag con datos básicos  y con una longitud mayor a 191 en el campo name', async ({ page,request }) => {
  await page.goto(GhostURL);
  await page.getByPlaceholder('jamie@example.com').click();
  await page.getByPlaceholder('jamie@example.com').fill(USERNAME);
  await page.getByPlaceholder('jamie@example.com').press('Tab');
...
test('TAG06. Crear Tag con datos que tengan formato inválido', async ({ page,request }) => {
  await page.goto(GhostURL);
  await page.getByPlaceholder('jamie@example.com').click();
  await page.getByPlaceholder('jamie@example.com').fill(USERNAME);
  await page.getByPlaceholder('jamie@example.com').press('Tab');
...
test('TAG07. Crear Tag y Crear un Post y agregar el tag al Post y visualizar el Preview', async ({ page,request }) => {
  await page.goto(GhostURL);
  await page.getByPlaceholder('jamie@example.com').click();
  await page.getByPlaceholder('jamie@example.com').fill(USERNAME);
  await page.getByPlaceholder('jamie@example.com').press('Tab');
